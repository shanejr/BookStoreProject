...
<body>
   <header>
			...
			<div id="responsive-nav">
				...
				<div class="category-nav show-on-click">
					...
					<ul class="category-list">
						<li><a href="books.html">Honor</a></li>
                        <li><a href="books.html">Mystery</a></li>
                        <li><a href="books.html">Comic</a></li>
                        <li><a href="books.html">Crime and Detective</a></li>
                        <li><a href="books.html">historical Fiction</a></li>
                        <li><a href="books.html">Science Fiction1</a></li>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="item">
                            ...
                            <h6><span class="price">$49</span> / <a href="Login.jsp">Buy Now</a></h6>
                            <div class="hover">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="item">
                            ...
                            <h6><span class="price">$19</span> / <a href="Login.jsp">Buy Now</a></h6>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="item">
                            ...
                            <h3><a href="Product-Detail.jsp">Keepers of the kalachakara</a></h3>
                            <h6><span class="price">$19</span> / <a href="Login.jsp">Buy Now</a></h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <div class="item">
                            ...
                            <h3><a href="Product-Detail.jsp">pers of the kalachakara</a></h3>
                            <h6><span class="price">$19</span> / <a href="Login.jsp">Buy Now</a></h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <div class="item">
                            <img src="user/images/r1.jpg" alt="img">
                            <h3><a href="Login.jsp">Keepers of the kalachakara</a></h3>
                            <h6><span class="price">$19</span> / <a href="Login.jsp">Buy Now</a></h6>
                        </div>
                    </div>
                    <div class="col-md-3">
    ...
    <script type="text/javascript" src="shopjs/owl.carousel.min.js"></script>
