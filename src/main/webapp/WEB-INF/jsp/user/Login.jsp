...
<body>
                ...
                <form>
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-12">
                            <button class="btn black"><a href="checkout">Login</a></button>
                            <h5>already Registered? <a href="register">Registered Here</a></h5>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <script type="user/shoptext/javascript" src="js/owl.carousel.min.js"></script>
